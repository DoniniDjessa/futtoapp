-- Localisations manuelles FUTTO — coller dans Supabase SQL Editor
...
create index if not exists futto_localisations_ville_idx on public.futto_localisations (ville);
create index if not exists futto_localisations_active_idx on public.futto_localisations (active);
